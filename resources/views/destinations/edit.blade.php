...
@section('breadcrumbs', 'Edit Layanan')
                    ...
                    <form action="{{route('destinations.update', [$destination->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-10">
                            <div class="mb-4">
                                ...
                                <input type="text" name="title" placeholder="Layanan Title..." class="form-control {{$errors->first('title') ? "is-invalid" : ""}}" value="{{$destination->title}}" required>
